...
Configure `maxPageSize` in `FilterModule.forRoot()` to cap the page size (see [Configuration](/docs/guides/configuration)).
...
- [Installation](/docs/guides/installation) -- per-ORM install commands, peer dependencies, and TypeScript config
...
- [Services](/docs/guides/services) -- `FilterRunner.apply()` and custom context
