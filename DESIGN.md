...
**Visual Reference:** Effect.website — monochromatic, white-on-black, typography-driven personality.
...
- Code block as centerpiece, well-padded, monochromatic syntax highlighting
- Install command bar: zinc border, monospace
- Primary CTA: white bg with black text (inverted), secondary CTAs: zinc border
- Before/After comparison cards with monochromatic labels
...
- **Do** show MikroORM and TypeORM examples in tabs wherever syntax differs.
